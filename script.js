...
// ============================================
const ROCKET_PARTS = [
    { id: "workshop", name: "Atelier", description: "Fabrique des pieces: +{gain} Parts/s\n% de la production: {percent}%\nTotal genere: {total} Parts", baseCost: 10, gain: 0.1, count: 0, image: "\ud83d\udee0\ufe0f", imgPath: "images/rocket/workshop.png", x: 30, y: 680, width: 100, height: 100, order: 1, unlockCondition: () => true, totalGenerated: 0 },
    ...
    { id: "launch-pad", name: "Pas de tir", description: "Lancement: +{gain} Parts/s\n% de la production: {percent}%\nTotal genere: {total} Parts", baseCost: 1000000000, gain: 10000000, count: 0, image: "\ud83d\ude80", imgPath: "images/rocket/launch-pad.png", x: 50, y: 120, width: 500, height: 700, order: 9, unlockCondition: () => score >= 100000000, totalGenerated: 0 },
