...
const GALACTIC_UPGRADES = [
    ...
    { id: 'prod7',  branch: 'production', tier: 7, name: 'Singularit\u00e9 technologique', desc: '+300% production globale.',      baseCost: 800, costMult: 1.0, maxLevel: 1, effectPerLevel: 3.0, requires: ['prod6'] },
    { id: 'prod8',  branch: 'production', tier: 8, name: 'Forge stellaire',          desc: '+400% production globale.',       baseCost: 2200, costMult: 1.0, maxLevel: 1, effectPerLevel: 4.0, requires: ['prod7'] },
