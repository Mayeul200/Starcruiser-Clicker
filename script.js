...
// ============================================
const ROCKET_PARTS = [
    { id: "workshop", name: "Atelier", description: "Fabrique des pieces: +{gain} Parts/s\n% de la production: {percent}%\nTotal genere: {total} Parts", baseCost: 10, gain: 0.1, count: 0, image: "\ud83d\udee0\ufe0f", imgPath: "images/rocket/workshop.png", x: 20, y: 550, width: 150, height: 150, order: 1, unlockCondition: () => true, totalGenerated: 0 },
    ...
    { id: "shield", name: "Bouclier", description: "Protection: +{gain} Parts/s\n% de la production: {percent}%\nTotal genere: {total} Parts", baseCost: 100000000, gain: 1000000, count: 0, image: "\ud83d\udee1\ufe0f", imgPath: "images/rocket/shield.png", x: 50, y: 228, width: 45, height: 59, order: 8, unlockCondition: () => score >= 10000000, totalGenerated: 0 },
    ...
    { id: "astronaut", name: "Astronaute", description: "Pilote: +{gain} Parts/s\n% de la production: {percent}%\nTotal genere: {total} Parts", baseCost: 10000000000, gain: 100000000, count: 0, image: "\ud83d\udc69\u200d\ud83d\ude80", imgPath: "images/rocket/astronaut.png", x: 40, y: 200, width: 50, height: 120, order: 10, unlockCondition: () => score >= 1000000000, totalGenerated: 0 },
];
