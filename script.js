...
// ============================================
const ROCKET_PARTS = [
    { id: "workshop", name: "Atelier", description: "Fabrique des pieces: +{gain} Parts/s\n% de la production: {percent}%\nTotal genere: {total} Parts", baseCost: 10, gain: 0.1, count: 0, image: "\ud83d\udee0\ufe0f", imgPath: "images/rocket/workshop.png", x: 20, y: 600, width: 150, height: 150, order: 1, unlockCondition: () => true, totalGenerated: 0 },
    ...
    { id: "rocket-body", name: "Corps", description: "Structure: +{gain} Parts/s\n% de la production: {percent}%\nTotal genere: {total} Parts", baseCost: 100000, gain: 1000, count: 0, image: "\ud83d\udfeb", imgPath: "images/rocket/body.png", x: 50, y: 332, width: 40, height: 200, order: 5, unlockCondition: () => score >= 25000, totalGenerated: 0 },
    { id: "boosters-left", name: "Boosters Gauche", description: "Propulsion supplémentaire: +{gain} Parts/s\n% de la production: {percent}%\nTotal genere: {total} Parts", baseCost: 1000000, gain: 10000, count: 0, image: "\ud83d\ude80", imgPath: "images/rocket/boosters-left.png", x: 45.8, y: 368, width: 50, height: 300, order: 6, unlockCondition: () => score >= 100000, totalGenerated: 0 },
    { id: "boosters-right", name: "Boosters Droit", description: "Propulsion supplémentaire: +{gain} Parts/s\n% de la production: {percent}%\nTotal genere: {total} Parts", baseCost: 1000000, gain: 10000, count: 0, image: "\ud83d\ude80", imgPath: "images/rocket/boosters-right.png", x: 54.2, y: 368, width: 50, height: 300, order: 6, unlockCondition: () => score >= 100000, totalGenerated: 0 },
    { id: "cockpit", name: "Cockpit", description: "Poste de pilotage: +{gain} Parts/s\n% de la production: {percent}%\nTotal genere: {total} Parts", baseCost: 10000000, gain: 100000, count: 0, image: "\ud83d\udc68\u200d\ud83d\ude80", imgPath: "images/rocket/cockpit.png", x: 50, y: 287, width: 45, height: 45, order: 7, unlockCondition: () => score >= 1000000, totalGenerated: 0 },
    { id: "shield", name: "Bouclier", description: "Protection: +{gain} Parts/s\n% de la production: {percent}%\nTotal genere: {total} Parts", baseCost: 100000000, gain: 1000000, count: 0, image: "\ud83d\udee1\ufe0f", imgPath: "images/rocket/shield.png", x: 50, y: 227, width: 45, height: 59, order: 8, unlockCondition: () => score >= 10000000, totalGenerated: 0 },
    { id: "launch-pad", name: "Pas de tir", description: "Lancement: +{gain} Parts/s\n% de la production: {percent}%\nTotal genere: {total} Parts", baseCost: 1000000000, gain: 10000000, count: 0, image: "\ud83d\ude80", imgPath: "images/rocket/launch-pad.png", x: 60.5, y: 210, width: 200, height: 513, order: 9, unlockCondition: () => score >= 100000000, totalGenerated: 0 },
    { id: "astronaut", name: "Astronaute", description: "Pilote: +{gain} Parts/s\n% de la production: {percent}%\nTotal genere: {total} Parts", baseCost: 10000000000, gain: 100000000, count: 0, image: "\ud83d\udc69\u200d\ud83d\ude80", imgPath: "images/rocket/astronaut.png", x: 40, y: 200, width: 100, height: 240, order: 10, unlockCondition: () => score >= 1000000000, totalGenerated: 0 },
];
