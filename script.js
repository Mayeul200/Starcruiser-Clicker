...
const ROCKET_PARTS = [
    ...
    { id: "rocket-body", name: "Corps", description: "Structure: +{gain} Parts/s\n% de la production: {percent}%\nTotal genere: {total} Parts", baseCost: 100000, gain: 1000, count: 0, image: "\ud83d\udfeb", imgPath: "images/rocket/body.png", x: 50, y: 332, width: 400, height: 400, order: 5, unlockCondition: () => score >= 25000, totalGenerated: 0 },
