...
const ROCKET_PARTS = [
    ...
    { id: "boosters-left", name: "Boosters Gauche", description: "Propulsion supplémentaire: +{gain} Parts/s\n% de la production: {percent}%\nTotal genere: {total} Parts", baseCost: 1000000, gain: 10000, count: 0, image: "\ud83d\ude80", imgPath: "images/rocket/boosters-left.png", x: 45.5, y: 365, width: 50, height: 300, order: 6, unlockCondition: () => score >= 100000, totalGenerated: 0 },
    { id: "boosters-right", name: "Boosters Droit", description: "Propulsion supplémentaire: +{gain} Parts/s\n% de la production: {percent}%\nTotal genere: {total} Parts", baseCost: 1000000, gain: 10000, count: 0, image: "\ud83d\ude80", imgPath: "images/rocket/boosters-right.png", x: 54.5, y: 365, width: 50, height: 300, order: 6, unlockCondition: () => score >= 100000, totalGenerated: 0 },
