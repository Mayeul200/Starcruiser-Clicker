...
const ROCKET_PARTS = [
    ...
    { id: "launch-pad", name: "Pas de tir", description: "Lancement: +{gain} Parts/s\n% de la production: {percent}%\nTotal genere: {total} Parts", baseCost: 1000000000, gain: 10000000, count: 0, image: "\ud83d\ude80", imgPath: "images/rocket/launch-pad.png",x: 60.2, y: 200, width: 180, height: 461, order: 9, unlockCondition: () => score >= 100000000, totalGenerated: 0 },
