...
const ROCKET_PARTS = [
    ...
    { id: "astronaut", name: "Astronaute", description: "Pilote: +{gain} Parts/s\n% de la production: {percent}%\nTotal genere: {total} Parts", baseCost: 10000000000, gain: 100000000, count: 0, image: "\ud83d\udc69\u200d\ud83d\ude80", imgPath: "images/rocket/astronaut.png", x: 35, y: 600, width: 25, height: 60, order: 10, unlockCondition: () => score >= 1000000000, totalGenerated: 0 },
];
...
function renderBuilding(building) {
    ...
    buildingElement.className = 'building-item' + (building.count === 0 ? ' not-purchased' : '') + (building.id !== 'launch-pad' && building.id !== 'workshop' && building.height > 100 ? ' tall' : '') + (building.id === 'workshop' ? ' workshop' : '');
