...
const ROCKET_PARTS = [
    ...
    { id: "launch-pad", name: "Pas de tir", description: "Lancement: +{gain} Parts/s\n% de la production: {percent}%\nTotal genere: {total} Parts", baseCost: 1000000000, gain: 10000000, count: 0, image: "\ud83d\ude80", imgPath: "images/rocket/launch-pad.png", x: 50, y: 700, width: 200, height: 600, order: 9, unlockCondition: () => score >= 100000000, totalGenerated: 0 },
