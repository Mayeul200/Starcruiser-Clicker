...
const ROCKET_PARTS = [
    ...
    { id: "nozzles", name: "Tuyères", description: "Propulsion: +{gain} Parts/s\n% de la production: {percent}%\nTotal genere: {total} Parts", baseCost: 100, gain: 1, count: 0, image: "🎯", imgPath: "images/rocket/nozzles.svg", x: 48, y: 85, width: 8, height: 6, order: 2, unlockCondition: () => score >= 50, totalGenerated: 0 },
    { id: "engines", name: "Moteurs", description: "Moteurs principaux: +{gain} Parts/s\n% de la production: {percent}%\nTotal genere: {total} Parts", baseCost: 1000, gain: 10, count: 0, image: "🔥", imgPath: "images/rocket/engines.svg", x: 47, y: 78, width: 10, height: 12, order: 3, unlockCondition: () => score >= 500, totalGenerated: 0 },
    { id: "fuel-tank", name: "Réservoir", description: "Carburant: +{gain} Parts/s\n% de la production: {percent}%\nTotal genere: {total} Parts", baseCost: 10000, gain: 100, count: 0, image: "⛽", imgPath: "images/rocket/fuel-tank.svg", x: 45, y: 60, width: 12, height: 18, order: 4, unlockCondition: () => score >= 5000, totalGenerated: 0 },
    { id: "rocket-body", name: "Corps", description: "Structure: +{gain} Parts/s\n% de la production: {percent}%\nTotal genere: {total} Parts", baseCost: 100000, gain: 1000, count: 0, image: "🟫", imgPath: "images/rocket/body.svg", x: 48, y: 45, width: 10, height: 25, order: 5, unlockCondition: () => score >= 25000, totalGenerated: 0 },
    { id: "wings", name: "Stabilisateurs", description: "Equilibre: +{gain} Parts/s\n% de la production: {percent}%\nTotal genere: {total} Parts", baseCost: 1000000, gain: 10000, count: 0, image: "✈️", imgPath: "images/rocket/wings.svg", x: 25, y: 55, width: 20, height: 8, order: 6, unlockCondition: () => score >= 100000, totalGenerated: 0 },
    { id: "cockpit", name: "Cockpit", description: "Poste de pilotage: +{gain} Parts/s\n% de la production: {percent}%\nTotal genere: {total} Parts", baseCost: 10000000, gain: 100000, count: 0, image: "👨‍🚀", imgPath: "images/rocket/cockpit.svg", x: 48, y: 25, width: 10, height: 12, order: 7, unlockCondition: () => score >= 1000000, totalGenerated: 0 },
    { id: "shield", name: "Bouclier", description: "Protection: +{gain} Parts/s\n% de la production: {percent}%\nTotal genere: {total} Parts", baseCost: 100000000, gain: 1000000, count: 0, image: "🛡️", imgPath: "images/rocket/shield.svg", x: 48, y: 20, width: 12, height: 8, order: 8, unlockCondition: () => score >= 10000000, totalGenerated: 0 },
    { id: "launch-pad", name: "Pas de tir", description: "Lancement: +{gain} Parts/s\n% de la production: {percent}%\nTotal genere: {total} Parts", baseCost: 1000000000, gain: 10000000, count: 0, image: "🚀", imgPath: "images/rocket/launch-pad.svg", x: 48, y: 90, width: 12, height: 6, order: 9, unlockCondition: () => score >= 100000000, totalGenerated: 0 },
    { id: "astronaut", name: "Astronaute", description: "Pilote: +{gain} Parts/s\n% de la production: {percent}%\nTotal genere: {total} Parts", baseCost: 10000000000, gain: 100000000, count: 0, image: "👩‍🚀", imgPath: "images/rocket/astronaut.svg", x: 50, y: 15, width: 6, height: 8, order: 10, unlockCondition: () => score >= 1000000000, totalGenerated: 0 }
];;;
