...
function renderBuilding(building) {
    ...
    const tooltip = `${percent}% | Total: ${formatNumber(totalGeneratedByBuilding[building.id] || 0)} | Unité: ${formatNumber(building.gain * buildingMultipliers[building.id] * autoMultiplier)}/s`;
